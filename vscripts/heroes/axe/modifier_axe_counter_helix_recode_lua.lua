...
function modifier_axe_counter_helix_recode_lua:OnAttacked(params)
    ...
    if caster:FindModifierByName("modifier_axe_counter_helix_recode_cooldown_lua") then return end
    ...
    if RollPercentage(self.chance) then
        caster:AddNewModifier( self:GetCaster(), self, "modifier_axe_counter_helix_recode_cooldown_lua", { duration = self.cooldown } )
